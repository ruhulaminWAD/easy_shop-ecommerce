		...
		<div class="sign-in-page">
			<div class="row">
                ...
                <div class="col-md-6 col-sm-6 sign-in">
                    ...
                    <form action="{{ route('login') }}" method="post" class="register-form outer-top-xs" role="form">@csrf
                ...
                <div class="col-md-6 col-sm-6 create-new-account">
                    ...
                    <form action="{{ route('register') }}" method="post" class="register-form outer-top-xs" role="form">@csrf
                        <div class="form-group">
