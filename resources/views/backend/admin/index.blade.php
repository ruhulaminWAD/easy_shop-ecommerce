...
@php
    ...
    $delivere  = App\Models\Order::where('status','delivere ')->get();
    $confirmd  = App\Models\Order::where('status','confirmd ')->get();
    $pending = App\Models\Order::where('status','pending')->get();
            ...
            <div class="box overflow-hidden pull-up">
                <div class="box-body">							
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">{{ count($user)}} <small class="text-success"><i class="fa fa-caret-up"></i></small></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box overflow-hidden pull-up">
                <div class="box-body">							
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">${{ $month }} <small class="text-danger"><i class="fa fa-caret-down"></i> USD</small></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="box overflow-hidden pull-up">
                <div class="box-body">							
                    ...
                    <div>
                        ...
                        <h3 class="text-white mb-0 font-weight-500">${{ $year }} <small class="text-danger"><i class="fa fa-caret-up"></i> USD</small></h3>
                    </div>
                </div>
            </div>
        </div>
