                                    ...
                                    <div class="product-tab">
                                                ...
                                                <div class="reviews">
                                                    <div class="review">
                                                        <div class="row" style="padding-bottom: 8px;">
                                                            <div class="col-3">
                                                            <img style="border-radius: 50%" src="{{ (!empty($review->user->profile_photo_path))? url('upload/user_profile_pic/'.$review->user->profile_photo_path):url('upload/no_image.jpg') }}" width="40px;" height="40px;"> 
                                                                <b style="padding-left: 8px;">{{ $review->user->name }}</b>
                                                            </div>
                                                            <div class="col-8"></div>
                                                        </div>
                                                        <div class="review-title"><span class="summary">{{ $review->summary }}</span><span class="date"><i class="fa fa-calendar"></i><span>{{ $review->created_at->diffForHumans() }}</span></span>
                                                        </div>
                                        ...
                                        <div class="product-add-review">
                                            ...
                                            <div class="review-form">
                                                @guest
                                                <p> 
                                                    <b> For Add Product Review. You Need to Login First <a href="{{ route('login') }}">Login Here</a> </b> 
                                                </p>
                                                @else
                                                <div class="form-container">
                                                    <form role="form" class="cnt-form" action="{{ route('review.store') }}" method="post"> @csrf
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-6">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control txt" id="summary" name="summary" value="{{ old('summary') }}">
                                                                    @error('summary')
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <textarea class="form-control txt txt-review" name="comment" id="comment" rows="4" >{{ old('comment') }}</textarea>
                                                                    @error('comment')
                                                                        <p class="text-danger">{{ $message  }}</p>
                                                                    @enderror
                                                                </div><!-- /.form-group -->
